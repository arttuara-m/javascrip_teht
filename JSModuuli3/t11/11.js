...
for (const picarticle of picArray) {
  const article = document.createElement('article');
  article.setAttribute('class', 'card');

  //header
  const header = document.createElement('header');
  header.innerText = picarticle.title;
  ...
  image.src = picarticle.image.medium;
  image.setAttribute('alt', 'title_from_picArray');
  figcap.innerText = picarticle.caption;
  ...
  desc.innerText = picarticle.description;
  ...
  article.addEventListener('click', () => {
    document.querySelector('dialog img').src = picarticle.image.medium
